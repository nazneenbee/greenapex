...
public class DepartmentController {
	...
	public Optional<DepartmentEntity> getStudentById(@PathVariable("Id") Integer Id)
	{
	...
	public Boolean deleteDepartment(@RequestParam("Id") Integer Id)
	{
		System.out.println("Delete Data By ID");
		return departmentService.deleteDepartmentDataById(Id);
    }
